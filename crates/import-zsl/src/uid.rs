pub fn database_level_uid(super_league_uid: &str) -> &str {
    match super_league_uid {
...
mod tests {
    ...
    #[test]
    fn matches_super_league_compatibility_map() {
        assert_eq!(
            database_level_uid("UkMpSTuFD0ipARO_Akane"),
            "Futuristic-bb_benji-01K848D1X4PDKPXYC5KZ05M8H1"
        );
        assert_eq!(database_level_uid("unchanged"), "unchanged");
    }
}
