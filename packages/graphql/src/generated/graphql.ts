...
export type Zc_TrackTournamentLobbyLeaderboardLiveSubscription = { trackTournament: { id: number, slug: string, leaderboard: { nodes: Array<{ tournamentId: number, userId: number, recordId: number, time: number, rank: number, user: { steamName: string | null } | null }> } } | null };
