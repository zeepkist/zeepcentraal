export const superLeagueLevelUidToDatabaseFileUid = new Map<string, string>([
...
export function toDatabaseLevelFileUid(superLeagueUid: string): string {
	return superLeagueLevelUidToDatabaseFileUid.get(superLeagueUid) ?? superLeagueUid
}
