	...
	await db
		...
		.onConflictDoUpdate({
			...
			set: {
				...
				distanceOnIce1: input.distanceOnIce1,
				distanceOnIce2: input.distanceOnIce2,
				distanceOnIce3: input.distanceOnIce3,
				distanceOnSoap: input.distanceOnSoap,
				distanceOnWood: input.distanceOnWood,
				distanceOnMud: input.distanceOnMud,
				timeOnTarmac: input.timeOnTarmac,
				timeOnGrass: input.timeOnGrass,
				timeOnSand: input.timeOnSand,
				timeOnIce1: input.timeOnIce1,
				timeOnIce2: input.timeOnIce2,
				timeOnIce3: input.timeOnIce3,
				timeOnSoap: input.timeOnSoap,
				timeOnWood: input.timeOnWood,
				timeOnMud: input.timeOnMud,
