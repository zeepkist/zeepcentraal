...
describe('level detail hero', () => {
	...
	it('maps competitiveness modifiers into centered difficulty tiers', () => {
		...
		expect(getLevelCompetitivenessRating(1)).toBe('easy')
		expect(getLevelCompetitivenessRating(1.2)).toBe('casual')
		expect(getLevelCompetitivenessRating(1.4)).toBe('balanced')
		expect(getLevelCompetitivenessRating(1.45)).toBe('competitive')
		expect(getLevelCompetitivenessRating(1.6)).toBe('hard')
