...
4. Sign in to ZeepCentraal with Steam or Discord to personalise your dashboard.

::content-alert{type="notice" title="No mod required to browse"}
You can explore all public ZeepCentraal pages and compete in community events before installing Modkist or GTR.
::
...
Use the [official Zeepkist Discord](https://discord.gg/zeepkist) and [Zeepkist modding Discord](https://discord.gg/zeepkist-modding) to find tournaments, community events, level feedback, and other players.
...
GTR submits completed runs to ZeepCentraal. After finishing your first level with GTR enabled, open [your record history](/records/me) and confirm the run appears.
