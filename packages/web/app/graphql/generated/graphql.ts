...
export type Zc_DashboardCriticalQuery = { records: { totalCount: number } | null, personalBestGlobals: { totalCount: number } | null, worldRecordGlobals: { totalCount: number } | null, levels: { totalCount: number } | null, votes: { totalCount: number } | null, activeRecords: { aggregates: { distinctCount: { userId: unknown } | null } | null } | null };
