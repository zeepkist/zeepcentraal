...
export type Zc_LevelSplitAnalysisQuery = { records: { nodes: Array<{ id: number, time: number, splits: Array<number | null> | null, speeds: Array<number | null> | null, user: { steamId: unknown, steamName: string | null } | null }> } | null };
