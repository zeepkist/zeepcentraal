...
export type Zc_UserPointsHistoryQuery = { baseline: { nodes: Array<{ dateCreated: unknown, points: number, totalPoints: number, rank: number, worldRecords: number }> } | null, history: { groupedAggregates: Array<{ keys: Array<string | null> | null, max: { points: number | null, totalPoints: number | null, worldRecords: number | null } | null, min: { rank: number | null } | null }> | null } | null };
...
export type Zc_UserSuperLeagueSeasonsQueryVariables = Exact<{ [key: string]: never; }>;


export type Zc_UserSuperLeagueSeasonsQuery = { zslSeasons: { nodes: Array<{ id: number, name: string, startDate: unknown, endDate: unknown }> } | null };
