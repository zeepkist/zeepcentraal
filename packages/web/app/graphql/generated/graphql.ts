...
export type Zc_ZslLevelQuery = { zslLevel: { id: number, roundId: number, round: { name: string, round: number, seasonId: number, season: { name: string } | null } | null, level: { xxHash: string, levelItems: { nodes: Array<{ name: string, imageUrl: string }> } } | null } | null, zslLevelResults: { totalCount: number, edges: Array<{ cursor: unknown, node: { position: number, points: number, time: number, user: { steamId: unknown, steamName: string | null } | null, record: { id: number } | null } }>, pageInfo: { startCursor: unknown, endCursor: unknown, hasNextPage: boolean, hasPreviousPage: boolean } } | null };
...
export type Zc_ZslRoundQuery = { zslRound: { id: number, round: number, name: string, eventDate: unknown, seasonId: number, season: { name: string } | null, zslLevels: { nodes: Array<{ id: number, level: { xxHash: string, levelItems: { nodes: Array<{ name: string, imageUrl: string }> } } | null }> } } | null, zslRoundResults: { totalCount: number, edges: Array<{ cursor: unknown, node: { position: number, points: number, user: { steamId: unknown, steamName: string | null } | null } }>, pageInfo: { startCursor: unknown, endCursor: unknown, hasNextPage: boolean, hasPreviousPage: boolean } } | null };
...
export type Zc_ZslSeasonQuery = { zslSeason: { id: number, name: string, startDate: unknown, endDate: unknown, zslRounds: { nodes: Array<{ id: number, round: number, name: string, eventDate: unknown }> } } | null, zslSeasonResults: { totalCount: number, edges: Array<{ cursor: unknown, node: { position: number, points: number, user: { steamId: unknown, steamName: string | null } | null } }>, pageInfo: { startCursor: unknown, endCursor: unknown, hasNextPage: boolean, hasPreviousPage: boolean } } | null };
