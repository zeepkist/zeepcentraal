...
export type Zc_ZslLevelQuery = { zslLevel: { id: number, roundId: number, round: { name: string, round: number, eventDate: unknown, seasonId: number, season: { name: string } | null } | null, level: { xxHash: string, levelItems: { nodes: Array<{ name: string, imageUrl: string, workshopId: unknown }> } } | null } | null };
