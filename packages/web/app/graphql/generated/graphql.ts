...
export type Zc_UserLevelsQuery = { recentUser: { levelItems: { nodes: Array<{ level: { id: number, xxHash: string, adventure: boolean, dateCreated: unknown, levelItems: { nodes: Array<{ name: string, imageUrl: string, validationTimeAuthor: number, validationTimeGold: number, validationTimeSilver: number, validationTimeBronze: number, author: { steamId: unknown, steamName: string | null } | null }> }, levelPoints: { points: number, rating: number, modifierPopularity: number } | null, records: { totalCount: number }, personalBestGlobals: { totalCount: number }, worldRecordGlobal: { record: { time: number } | null, user: { steamId: unknown, steamName: string | null } | null } | null } | null }> } } | null, popularLevels: { nodes: Array<{ id: number, xxHash: string, adventure: boolean, dateCreated: unknown, periodRecords: { totalCount: number }, levelItems: { nodes: Array<{ name: string, imageUrl: string, validationTimeAuthor: number, validationTimeGold: number, validationTimeSilver: number, validationTimeBronze: number, author: { steamId: unknown, steamName: string | null } | null }> }, levelPoints: { points: number, rating: number, modifierPopularity: number } | null, records: { totalCount: number }, personalBestGlobals: { totalCount: number }, worldRecordGlobal: { record: { time: number } | null, user: { steamId: unknown, steamName: string | null } | null } | null }> } | null };
...
export type Zc_UserPointsHistoryQuery = { baseline: { nodes: Array<{ dateCreated: unknown, points: number, totalPoints: number, rank: number }> } | null, history: { groupedAggregates: Array<{ keys: Array<string | null> | null, max: { points: number | null, totalPoints: number | null } | null, min: { rank: number | null } | null }> | null } | null };
...
export type Zc_UserStatisticsQuery = { allStatistics: { totalCount: number, aggregates: { sum: { distance: number } | null } | null } | null, v6Statistics: { totalCount: number, aggregates: { sum: { distance: number, distanceInAir: number, distanceOn1Wheel: number, distanceOn2Wheels: number, distanceOn3Wheels: number, distanceOn4Wheels: number, distanceOnGrass: number, distanceOnGround: number, distanceOnIce: number, distanceOnMetal: number, distanceOnSand: number, distanceOnSnow: number, distanceOnSoap: number, distanceOnTarmac: number, distanceRagdoll: number, time: number, timeInAir: number, timeOnGrass: number, timeOnGround: number, timeOnIce: number, timeOnMetal: number, timeOnSand: number, timeOnSnow: number, timeOnSoap: number, timeOnTarmac: number, timeRagdoll: number, turnLeftCount: unknown, turnRightCount: unknown, armsUpCount: unknown, brakeCount: unknown, hornCount: unknown } | null, average: { averageGforce: number | null, averageSpeed: number | null } | null, max: { maxGforce: number | null, maxSpeed: number | null } | null } | null } | null };
...
export type Zc_ZslRoundStandingFieldsFragment = { position: number, points: number, userId: number, user: { id: number, steamId: unknown, steamName: string | null } | null };
...
export type Zc_ZslRoundResultsQuery = { zslRoundResults: { totalCount: number, edges: Array<{ cursor: unknown, node: { position: number, points: number, userId: number, user: { id: number, steamId: unknown, steamName: string | null } | null } }>, pageInfo: { startCursor: unknown, endCursor: unknown, hasNextPage: boolean, hasPreviousPage: boolean } } | null, viewerStanding?: { nodes: Array<{ position: number, points: number, userId: number, user: { id: number, steamId: unknown, steamName: string | null } | null }> } | null };
...
export type Zc_ZslSeasonStandingFieldsFragment = { position: number, points: number, userId: number, user: { id: number, steamId: unknown, steamName: string | null } | null };
...
export type Zc_ZslSeasonResultsQuery = { zslSeasonResults: { totalCount: number, edges: Array<{ cursor: unknown, node: { position: number, points: number, userId: number, user: { id: number, steamId: unknown, steamName: string | null } | null } }>, pageInfo: { startCursor: unknown, endCursor: unknown, hasNextPage: boolean, hasPreviousPage: boolean } } | null, viewerStanding?: { nodes: Array<{ position: number, points: number, userId: number, user: { id: number, steamId: unknown, steamName: string | null } | null }> } | null };
