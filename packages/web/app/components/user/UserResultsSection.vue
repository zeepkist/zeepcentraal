<template>
	<section :aria-labelledby="id">
		...
		<DataState :pending="pending" :empty="records.length === 0" :loading-label="paginationLabels.label" :error-title="paginationLabels.label" :empty-title="paginationLabels.label">
