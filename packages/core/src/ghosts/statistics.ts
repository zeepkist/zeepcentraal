...
export function calculateGhostStatisticsFromIterable(
	...
	return {
		...
		distanceOnWood: hasSurfaceStats ? surfaceDistance.wood : null,
		distanceOnMud: hasSurfaceStats ? surfaceDistance.mud : null,
		distanceOnIce1: hasSurfaceStats ? surfaceDistance.ice1 : null,
		distanceOnIce2: hasSurfaceStats ? surfaceDistance.ice2 : null,
		distanceOnIce3: hasSurfaceStats ? surfaceDistance.ice3 : null,
		...
		timeOnWood: hasSurfaceStats ? surfaceTime.wood : null,
		timeOnMud: hasSurfaceStats ? surfaceTime.mud : null,
		timeOnIce1: hasSurfaceStats ? surfaceTime.ice1 : null,
		timeOnIce2: hasSurfaceStats ? surfaceTime.ice2 : null,
		timeOnIce3: hasSurfaceStats ? surfaceTime.ice3 : null,
